...
export function Header() {
  return (
    <header className="flex w-full fixed px-3 md:px-5 bg-background text-primary z-50">
      <div className="w-full md:max-w-4xl lg:max-w-5xl xl:max-w-7xl flex items-center justify-between mx-auto py-5 border-b border-primary-foreground/25">
        {/* DESKTOP MAIN NAV */}
        <DesktopMainNav />
