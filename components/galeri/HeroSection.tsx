export function HeroSection() {
  return (
    <section className="flex items-center justify-center bg-[url(https://qbbs2frdex6nzjnr.public.blob.vercel-storage.com/hero-image-galeri-sintaks-rupa.webp)] bg-cover bg-center">
